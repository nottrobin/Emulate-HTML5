...
YUI.add(
    ...
    function (Y) {
        ...
        Y.emulateHTML5.Loader = function (config) { Y.emulateHTML5.Loader.superclass.constructor.apply(this, arguments); }
        Y.emulateHTML5.Loader.NAME = "eH5-loader";
        ...
        Y.extend(Y.emulateHTML5.Loader, Y.Base, {
            ...
            initializer: function () {
                ...
                for(var compIndex in components) {
                    ...
                    Y.use(this.get('prefix') + '-' + lcComponentName);
                    Y[this.get('namespace')][ucfComponentName].init(configOptions);
        ...
        Y.emulateHTML5.Loader.load = function(components) {
            new Y.emulateHTML5.Loader({ 'components': components });
        }
    }, 
    '0.1',  /* module version */
...
YUI.add(
    ...
    function (Y) {
        ...
        Y.emulateHTML5.Shim.NAME = "eH5-shim";
...
window.EmulateHTML5 = {
    version	: '0.1',
    Loader 	: function (components) {
        YUI().use('emulateHTML5-loader', function(Y) {
            Y.emulateHTML5.Loader.load(components);
        });
    }
}
